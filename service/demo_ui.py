...
def get_demo_html() -> str:
    """Return HTML for the interactive /demo page."""
    return """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <section>
    ...
    <p class="small">
      This shows the raw HTTP call that was made and the JSON response.
      You can use this in the sprint review to talk about status codes and sad paths.
    </p>
